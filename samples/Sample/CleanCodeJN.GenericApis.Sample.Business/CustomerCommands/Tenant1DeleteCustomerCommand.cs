...
/// <summary>
/// Tenant1-specific handler for DeleteCustomerIntegrationRequest.
/// Discovered automatically by the TenantCommandRegistry at startup via IMultiTenantHandler.
/// Only invoked when the configured claim resolves to "Tenant1".
/// </summary>
public class Tenant1DeleteCustomerCommand(ICommandExecutionContext executionContext)
