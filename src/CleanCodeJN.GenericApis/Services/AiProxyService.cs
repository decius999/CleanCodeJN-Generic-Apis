...
/// <summary>
/// Provides an agentic AI proxy that forwards chat messages to the Anthropic Claude API and executes MCP tool calls in a loop.
/// </summary>
...
{
    /// <summary>
    /// Streams a chat response from Claude, executing MCP tool calls as needed until Claude produces a final text reply.
    /// </summary>
