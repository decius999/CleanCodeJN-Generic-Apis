...
/// <summary>
/// Default <see cref="ILlmProvider"/> implementation that forwards requests to the Anthropic Claude API
/// and executes MCP tool calls in an agentic loop.
/// </summary>
public class AnthropicLlmProvider(IOptions<AiProxyOptions> options, IHttpClientFactory httpClientFactory, ILogger<AnthropicLlmProvider> logger) : ILlmProvider
{
    /// <inheritdoc/>
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        var anthropic = new AnthropicClient(options.Value.LlmApiKey);
