...
app.UseCleanCodeJNWithMcp();                                    // For autogenerated MCP Server (AI-callable tools)
app.UseCleanCodeJNWithDocumentation();                          // For autogenerated Command Documentation, visit /docs
...
- ✅ **AI-ready MCP Server** – one line turns your entire API into AI-callable tools
...
- 🤖 **Auto-generated MCP Server** — every CRUD endpoint becomes an AI-callable tool instantly
...
- Add app.UseCleanCodeJNWithMcp() to your Program.cs to expose your API as an MCP Server
